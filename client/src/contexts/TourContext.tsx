...
export const TOUR_STEPS: TourStep[] = [
  {
    id: "tour-hub",
    title: "The Hub",
    description: "Drop any business thought here, anytime. Updates, tasks, issues — captured instantly between owners.",
    icon: "⚡",
    shape: "circle",
    padding: 12,
  },
  {
    ...
    description: "Your structured meeting rhythm lives here. Daily huddles, weekly reviews, monthly check-ins — all in one place.",
    icon: "📅",
    shape: "rect",
    padding: 8,
  },
  {
    id: "tour-goals",
    title: "Goals",
    description: "Track what matters most to your business. Set targets, measure progress, and stay aligned as a team.",
    icon: "🎯",
    shape: "rect",
    padding: 8,
  },
  {
    id: "tour-sleep",
    title: "Sleep Mode",
    description: "Turn this on when you're off the clock. Notifications pause so you can truly disconnect.",
    icon: "🌙",
    shape: "circle",
    padding: 10,
  },
