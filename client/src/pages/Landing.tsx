      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button
              ...
              className="bg-[#33A2DB] text-[#0F2440] text-sm font-semibold px-5 py-2 rounded-lg hover:bg-[#2485b8] transition-colors active:scale-[0.97]"
            >
              Download Free
            </button>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-white/10 py-4 flex flex-col gap-4">
            ...
            <button
              onClick={() => scrollTo("download")}
              className="bg-[#33A2DB] text-[#0F2440] text-sm font-semibold px-5 py-2 rounded-lg mx-2"
            >
              Download Free
            </button>
          </div>
  ...
  if (submitted) {
    return (
      <div className={`flex items-center gap-3 ${variant === "hero" ? "justify-center" : ""}`}>
        <div className="w-10 h-10 rounded-full bg-[#33A2DB]/20 flex items-center justify-center flex-shrink-0">
          <svg className="w-5 h-5 text-[#33A2DB]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <form onSubmit={handleSubmit} className={`flex gap-3 ${variant === "hero" ? "flex-col sm:flex-row justify-center w-full max-w-md mx-auto" : "flex-col sm:flex-row max-w-md"}`}>
      <input
        ...
        className="flex-1 px-4 py-3 rounded-lg border bg-white/10 border-white/20 text-white placeholder:text-white/40 focus:border-[#33A2DB]/60 focus:ring-2 focus:ring-[#33A2DB]/20 outline-none transition-all text-sm"
      />
      <button
        type="submit"
        disabled={join.isPending}
        className="px-6 py-3 rounded-lg text-sm font-semibold transition-all active:scale-[0.97] whitespace-nowrap bg-[#33A2DB] text-[#0F2440] hover:bg-[#2485b8] disabled:opacity-60"
      >
    ...
    <section className="pt-32 pb-28 px-4" style={{ background: "linear-gradient(160deg, #0F2440 0%, #1E3A5F 60%, #0D2D4A 100%)" }} aria-labelledby="hero-heading">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-12 animate-fade-in">
          <img
            ...
            style={{
              ...
              height: 180,
              objectFit: "contain",
              filter: "drop-shadow(0 12px 40px rgba(51,162,219,0.40)) drop-shadow(0 4px 12px rgba(0,0,0,0.50))",
            }}
          />
        ...
        <div className="text-center animate-fade-up">
          <div className="inline-flex items-center gap-2 bg-white/10 text-[#33A2DB] text-xs font-semibold px-4 py-1.5 rounded-full mb-8 border border-white/10">
            <span className="w-1.5 h-1.5 rounded-full bg-[#33A2DB] animate-pulse" aria-hidden="true" />
          ...
          <h1 id="hero-heading" className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            ...
            <span className="text-[#33A2DB]">to the Dinner Table.</span>
          </h1>
    ...
    <section id="problem" className="py-20 px-4" style={{ background: "linear-gradient(180deg, #0D2D4A 0%, #0F2440 100%)" }} aria-labelledby="problem-heading">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-[#33A2DB] text-sm font-semibold uppercase tracking-widest mb-3">Sound Familiar?</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {PROBLEMS.map((p, i) => (
            <div
              key={i}
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-[#33A2DB]/30 hover:bg-white/8 transition-all duration-200"
            >
          ...
          {/* CTA card */}
          <div className="bg-[#33A2DB]/10 rounded-2xl p-6 border border-[#33A2DB]/20 flex flex-col justify-between">
            <div>
            ...
            <button
              ...
              className="mt-6 bg-[#33A2DB] text-[#0F2440] text-sm font-semibold px-5 py-2.5 rounded-lg hover:bg-[#2485b8] transition-colors active:scale-[0.97]"
            >
              Download the App →
            </button>
          </div>
...
function FeaturesSection() {
  return (
    <section id="features" className="py-20 px-4 bg-[#0F2440]" aria-labelledby="features-heading">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-[#33A2DB] text-sm font-semibold uppercase tracking-widest mb-3">What's Inside</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map((f, i) => (
            <div
              key={i}
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:border-[#33A2DB]/30 hover:bg-white/8 transition-all duration-200 group"
            >
              <div className="w-11 h-11 rounded-xl bg-[#1E3A5F] text-[#33A2DB] flex items-center justify-center mb-4 group-hover:bg-[#33A2DB]/20 transition-colors border border-white/10">
                {f.icon}
              </div>
...
const CADENCE = [
  ...
  { freq: "Monthly", time: "60 min", color: "#33A2DB", desc: "A financial review to go over the numbers, check progress against goals, and course-correct before the quarter ends." },
  ...
  return (
    <section className="py-20 px-4" style={{ background: "linear-gradient(180deg, #1E3A5F 0%, #162d4a 100%)" }} aria-labelledby="cadence-heading">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          <p className="text-[#33A2DB] text-sm font-semibold uppercase tracking-widest mb-3">The Cadence</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {CADENCE.map((c, i) => (
            <div key={i} className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors">
              ...
              <div className="text-[#33A2DB]/80 text-sm font-medium mb-3">{c.time}</div>
...
function PricingSection() {
  ...
  const plans = [
    ...
    },
    {
      ...
      ctaClass: "bg-[#33A2DB] text-[#0F2440] hover:bg-[#2485b8]",
      popular: false,
    },
    {
      id: "co_owner_team",
    ...
    <section id="pricing" className="py-20 px-4 bg-[#0F2440]" aria-labelledby="pricing-heading">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
          <p className="text-[#33A2DB] text-sm font-bold uppercase tracking-widest mb-3">Pricing</p>
          ...
          {/* Trial banner */}
          <div className="inline-flex items-center gap-3 bg-[#33A2DB]/10 border border-[#33A2DB]/25 rounded-2xl px-6 py-3 text-sm mb-8">
            <span className="w-2 h-2 rounded-full bg-[#33A2DB] animate-pulse flex-shrink-0" aria-hidden="true" />
            <span className="text-[#33A2DB] font-semibold">14-day free trial on all plans</span>
            ...
            >
              ...
              <div className="mb-6">
                ...
                {billing === "annual" ? (
                  ...
                  <p className="text-[#33A2DB]/60 text-xs mt-1 font-medium">
                    Switch to annual and save {plan.id === "founding" ? "$120" : plan.id === "co_owner" ? "$204" : "$240"}/yr
                  </p>
                )}
                <p className="text-[#33A2DB]/70 text-xs mt-0.5 font-medium">Both owners included — no per-seat fees</p>
              </div>
              ...
              <ul className="space-y-2.5 mb-8 flex-1">
                {plan.features.map((item, i) => (
                  <li key={i} className="flex items-start gap-2.5 text-sm text-white/70">
                    <span className={`mt-0.5 flex-shrink-0 font-bold ${plan.id === "founding" ? "text-[#F59E0B]" : "text-[#33A2DB]"}`}>✓</span>
                    {item}
                  </li>
                ))}
              </ul>
    ...
    <section id="story" className="py-20 px-4 bg-[#0F2440]" aria-labelledby="story-heading">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white/5 rounded-2xl p-8 sm:p-10 border border-white/10">
          <div className="text-[#33A2DB] text-6xl font-serif leading-none mb-4 opacity-30 select-none" aria-hidden="true">"</div>
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
          {[
            ...
            <div key={i} className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-[#33A2DB]/20 flex items-center justify-center text-[#33A2DB] text-xs font-bold flex-shrink-0" aria-hidden="true">
                {item.icon}
              </div>
        ...
        {data && data.count > 0 && (
          <p className="mt-8 text-sm text-white/40">
            <span className="text-[#33A2DB] font-semibold">{data.count} business owners</span> are already on the waitlist.
          </p>
        )}
