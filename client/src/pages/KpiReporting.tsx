/**
 * KPI Reporting Page — dark navy theme (#0F2440 bg, #33A2DB teal accent)
 */
  ...
  return (
    <div className="flex flex-col gap-6">
          ...
          {businesses.map(b => (
            <button key={b.slug} onClick={() => setSelectedBusiness(b.slug)}
              ...
              style={{
                ...
                border: `1.5px solid ${selectedBusiness === b.slug ? "#33A2DB" : "rgba(255,255,255,0.1)"}`,
      ...
      <div className="rounded-2xl p-5 flex flex-col gap-4"
        style={{ background: "linear-gradient(135deg, rgba(51,162,219,0.07) 0%, rgba(51,162,219,0.03) 100%)", border: "1.5px solid rgba(51,162,219,0.2)", boxShadow: "0 4px 24px rgba(51,162,219,0.06)" }}>
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <div style={{ width: 28, height: 28, borderRadius: 8, background: "rgba(51,162,219,0.18)", border: "1px solid rgba(51,162,219,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14 }}>📈</div>
            <div>
