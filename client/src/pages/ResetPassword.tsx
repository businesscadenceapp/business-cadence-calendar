          ...
          <div className="rounded-2xl p-8" style={cardStyle}>
            ...
            {!token && (
              <div className="text-center py-4">
                ...
                <a href="/forgot-password" className="text-sm font-semibold" style={{ color: "#5EEAD4" }}>
                  Request new link →
                </a>
              </div>
            )}
            ...
            {token && !validating && tokenData && !tokenData.valid && (
              <div className="text-center py-4">
                ...
                <a href="/forgot-password" className="inline-block text-sm font-semibold" style={{ color: "#5EEAD4" }}>
                  Request a new link →
                </a>
              </div>
            )}
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#5EEAD4", color: "#0F2440", boxShadow: "0 4px 16px rgba(94,234,212,0.25)" }}
                  >
