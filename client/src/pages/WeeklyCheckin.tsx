 ...
 * Dark navy theme: #0F2440 bg, #33A2DB teal accent, #C4B5FD purple accent
 */
      ...
      <div className="max-w-2xl mx-auto px-3 sm:px-5 py-4 sm:py-6">
        ...
        {totalCount > 0 && (
          <div className="mb-6">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[11px] font-bold" style={{ color: allDone ? "#33A2DB" : "rgba(255,255,255,0.5)", fontFamily: "'JetBrains Mono', monospace" }}>
            ...
            <div className="h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: "rgba(255,255,255,0.08)" }}>
              <div
                ...
                style={{
                  ...
                  background: allDone
                    ? "linear-gradient(90deg, #33A2DB, #2485b8)"
        ...
        {allDone && (
          <div
            ...
            style={{ backgroundColor: "rgba(51,162,219,0.08)", border: "1.5px solid rgba(51,162,219,0.25)" }}
          >
            <p className="text-[15px] font-bold" style={{ color: "#33A2DB", fontFamily: "'Space Grotesk', sans-serif" }}>
              ✓ All questions answered for this week!
            </p>
            <p className="text-[12px] mt-1" style={{ color: "rgba(51,162,219,0.7)" }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${isSaved ? "rgba(51,162,219,0.25)" : "rgba(255,255,255,0.08)"}`,
                  }}
                >
                  {/* Question header */}
                  <div className="flex items-start gap-3">
                    <span
                      ...
                      style={{
                        backgroundColor: isSaved ? "rgba(51,162,219,0.15)" : "rgba(196,181,253,0.15)",
                        color: isSaved ? "#33A2DB" : "#C4B5FD",
                      }}
                    >
                      {isSaved ? "✓" : idx + 1}
                    </span>
                  ...
                  <textarea
                    ...
                    style={{
                      ...
                      border: `1.5px solid ${isSaved ? "rgba(51,162,219,0.2)" : "rgba(255,255,255,0.1)"}`,
                  ...
                  <div className="flex items-center justify-between">
                    {isSaved ? (
                      <span className="text-[11px] font-semibold" style={{ color: "#33A2DB" }}>✓ Saved</span>
                    ) : (
                    ...
                    <button
                      ...
                      style={{
                        backgroundColor: isSaved ? "rgba(51,162,219,0.1)" : "#C4B5FD",
                        color: isSaved ? "#33A2DB" : "#0F2440",
                        border: isSaved ? "1px solid rgba(51,162,219,0.25)" : "none",
