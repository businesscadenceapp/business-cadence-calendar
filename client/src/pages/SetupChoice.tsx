    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(51,162,219,0.12) 0%, transparent 70%)" }}
        />
        {/* Subtle grid */}
        <div
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(51,162,219,0.15) 0%, rgba(37,220,249,0.08) 100%)",
            border: "1px solid rgba(51,162,219,0.25)",
            boxShadow: "0 0 48px rgba(51,162,219,0.12), inset 0 1px 0 rgba(51,162,219,0.2)",
          }}
        >
          {/* Two interlocking rings — partnership */}
          <svg className="w-12 h-12 text-[#33A2DB]" fill="none" stroke="currentColor" viewBox="0 0 48 48">
      ...
      <div className="relative z-10 px-6 pb-8 flex flex-col gap-3 max-w-md mx-auto w-full">
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 4px 24px rgba(51,162,219,0.25), 0 1px 0 rgba(255,255,255,0.15) inset",
          }}
        >
          Set up now →
        </button>
