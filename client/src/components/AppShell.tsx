...
const EMPLOYEE_NAV: NavItem[] = [
  ...
  { path: "/app/team/calendar", label: "Schedule",  icon: "📅", activeColor: "#33A2DB" },
  { path: "/app/kpi",           label: "KPIs",      icon: "📈", activeColor: "#33A2DB" },
  { path: "/app/messages",      label: "Messages",  icon: "💬", activeColor: "#33A2DB" },
  { path: "/app/checkin",       label: "Check-in",  icon: "✅", activeColor: "#33A2DB" },
];
          ...
          {items.map(item => {
            ...
            return (
              <Link
                ...
                style={{
                  backgroundColor: isActive ? "rgba(51,162,219,0.12)" : "transparent",
                  color: isActive ? "#33A2DB" : "rgba(255,255,255,0.7)",
              ...
              >
                ...
                {item.label}
                {isActive && (
                  <div className="ml-auto w-2 h-2 rounded-full" style={{ backgroundColor: "#33A2DB" }} />
                )}
              </Link>
            );
          })}
            ...
            {isOwnerOrCoOwner && TEAM_ENABLED && (
              ...
              >
                <Link
                  ...
                  style={{
                    backgroundColor: !activePath.startsWith("/app/team") ? "rgba(51,162,219,0.18)" : "transparent",
                    color: !activePath.startsWith("/app/team") ? "#33A2DB" : "rgba(255,255,255,0.4)",
                    fontFamily: "'Space Grotesk', sans-serif",
              ...
              : NAV_ITEMS.map(item => {
                  ...
                  return (
                    <Link
                      ...
                      style={{
                        backgroundColor: isActive ? "rgba(51,162,219,0.12)" : "transparent",
                        color: isActive ? "#33A2DB" : "rgba(255,255,255,0.55)",
                        fontFamily: "'Space Grotesk', sans-serif",
                      }}
                    >
                      <span className="text-base w-5 text-center flex-shrink-0">{item.icon}</span>
          ...
          >
            ...
            {isOwnerOrCoOwner && TEAM_ENABLED && (
              ...
              >
                <Link
                  ...
                  style={{
                    backgroundColor: !activePath.startsWith("/app/team") ? "rgba(51,162,219,0.2)" : "transparent",
                    color: !activePath.startsWith("/app/team") ? "#33A2DB" : "rgba(255,255,255,0.4)",
                    fontFamily: "'Space Grotesk', sans-serif",
                    borderRadius: "10px 0 0 10px",
                    minHeight: "36px",
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                ...
                style={{
                  backgroundColor: moreIsActive ? "rgba(51,162,219,0.18)" : "rgba(255,255,255,0.06)",
                  border: moreIsActive ? "1px solid rgba(51,162,219,0.4)" : "1px solid rgba(255,255,255,0.1)",
                }}
                title="Menu"
              >
