 ...
 *
 * Design: dark navy theme (#0F2440 bg, #33A2DB teal accent)
 */
      ...
      >
        ...
        <div className="px-6 pt-4 pb-8">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            >
              <Users size={22} style={{ color: "#33A2DB" }} />
            </div>
            <div>
          ...
          >
            <p className="text-xs font-semibold mb-3" style={{ color: "#33A2DB" }}>HOW IT WORKS</p>
              ...
              {[
                ...
                <div key={step} className="flex items-start gap-3">
                  <div
                    ...
                    style={{ backgroundColor: "rgba(51,162,219,0.2)", border: "1px solid rgba(51,162,219,0.4)" }}
                  >
                    <span className="text-xs font-bold" style={{ color: "#33A2DB" }}>{step}</span>
                  </div>
          ...
          {!inviteUrl ? (
            ...
            <button
              ...
              style={{
                ...
                color: "#0F2440",
                boxShadow: "0 4px 20px rgba(51,162,219,0.3)",
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  style={{
                    backgroundColor: copied ? "rgba(51,162,219,0.15)" : "rgba(255,255,255,0.08)",
                    border: `1px solid ${copied ? "rgba(51,162,219,0.4)" : "rgba(255,255,255,0.15)"}`,
                    color: copied ? "#33A2DB" : "rgba(255,255,255,0.8)",
                  }}
                >
