...
export default function TourOverlay() {
  ...
  const coachStyle: React.CSSProperties = {
    ...
    border: "1.5px solid rgba(51,162,219,0.3)",
    borderRadius: "20px",
    padding: "20px",
    boxShadow: "0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(51,162,219,0.08)",
    ...
    >
      ...
      <div
        style={{
          ...
          border: "2px solid rgba(51,162,219,0.7)",
          boxShadow: "0 0 0 4px rgba(51,162,219,0.15), 0 0 24px rgba(51,162,219,0.3)",
          pointerEvents: "none",
          transition: "all 300ms cubic-bezier(0.23, 1, 0.32, 1)",
        }}
      />
      ...
      <div style={coachStyle}>
        ...
        {arrowUp && (
          <div
            style={{
              ...
              borderBottom: "10px solid rgba(51,162,219,0.3)",
            }}
          />
        )}
        {arrowUp && (
        ...
        {arrowDown && (
          <div
            style={{
              ...
              borderLeft: "10px solid transparent",
              borderRight: "10px solid transparent",
              borderTop: "10px solid rgba(51,162,219,0.3)",
            }}
          />
        )}
        {arrowDown && (
            ...
            {TOUR_STEPS.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 6,
                  borderRadius: 3,
                  backgroundColor: i === stepIndex ? "#33A2DB" : "rgba(255,255,255,0.2)",
                  transition: "all 300ms cubic-bezier(0.23, 1, 0.32, 1)",
                }}
              />
            ))}
        ...
        <div className="flex items-center gap-3 mb-2">
          <div
            style={{
              ...
              fontSize: "20px",
              flexShrink: 0,
              boxShadow: "0 0 12px rgba(51,162,219,0.12)",
            }}
          >
            {currentStep.icon}
          </div>
        ...
        <button
          ...
          style={{
            ...
            boxShadow: "0 4px 16px rgba(51,162,219,0.3)",
          }}
